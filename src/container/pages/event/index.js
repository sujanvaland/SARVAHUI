            ...
            <div className='cntpagecomponent'>
                <div className='centersidebarcontent flexcolumn mt56'>
                    <div className='tabbox'>
                        ...
                        <Button onClick={() => showTimeLine('comingEvent')} className={type === 'comingEvent' ? 'btntab active' : 'btntab'}> Up Coming Event</Button>
                        <Button onClick={() => showTimeLine('myEvent')} className={type === 'myEvent' ? 'btntab active' : 'btntab'}> My Event </Button>
